...
following the original labelling protocol. Each imagine has been labelled by
multiple labellers, and depending on the strategy used to select which images
to include among the 10 chosen for the given class there are three different
versions of the dataset. Please refer to section four of the paper for more
details on how the different variants were compiled.
...
_IMAGENET_V2_URLS = {
    ...
    'topimages': f'{_ROOT_URL}/imagenetv2-topimages.tar.gz',
}
_TAR_TOPDIR = {
